<div class="contenedor-list-all">
    ...
    <?php if ($paginaActual > 1): ?>
        <a href="index.php?controller=pelicula&action=listAll&page=<?php echo $paginaActual - 1; ?>" class="cambiarPagina"><img src="assets/Images/anterior.png" class="paginar"></a>
    <?php endif; ?>
    <?php for ($i = 1; $i <= $dataToView["totalPaginas"]; $i++): ?>
        <a href="index.php?controller=pelicula&action=listAll&page=<?= $i ?>" <?= $i == $_GET["page"] ? 'style="font-weight:bold; pointer-events: none; "' : '' ?>>
        ...
        <a href="index.php?controller=pelicula&action=listAll&page=<?php echo $paginaActual + 1; ?>" class="cambiarPagina"><img src="assets/Images/siguiente-boton.png" class="paginar"></a>
    <?php endif; ?>
    </div>
</div>